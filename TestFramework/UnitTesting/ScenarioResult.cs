...
namespace Microsoft.Silverlight.Testing.Harness
{
    ...
    public class ScenarioResult
    {
        ...
        /// <summary>
        /// Get the TestContext Output for this scenario
        /// </summary>
        ...
        public ScenarioResult(ITestMethod method, ITestClass testClass, TestOutcome result, Exception exception, IEnumerable<string> output)
        {
            TestClass = testClass;
            TestMethod = method;
            Exception = exception;
